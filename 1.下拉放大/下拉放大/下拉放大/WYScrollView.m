...
{
    if (self.netDelagate) {
        if ([self.netDelagate respondsToSelector:@selector(didSelectedNetImageAtIndex:)]) {
            [self.netDelagate didSelectedNetImageAtIndex:_currentIndex];
        }
    }
    
    if (self.localDelagate) {
        if ([self.localDelagate respondsToSelector:@selector(didSelectedLocalImageAtIndex:)]) {
